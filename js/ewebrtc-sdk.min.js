...
f.logError("Error adding participant"),f.logTrace(a),g(a)}})}catch(b){f.logError("Error adding participant"),f.logTrace(b),g(b)}}function S(a){f.logDebug("ATT.rtc.Call: removeParticipant"),f.logTrace(a);try{Ca.removeParticipant({sessionInfo:la,participant:a,confId:da,onSuccess:function(){f.logDebug("rtcManager.removeParticipant: onSuccess"),f.logInfo("Successfully removed participant"),delete na.participants()[a],Ba.publish("participant-removed",h())},onError:function(a){f.logDebug("rtcManager.removeParticipant: onError"),f.logError("Error removing participant"),f.logTrace(a),g(a)}})}catch(b){f.logError("Error removing participant"),f.logTrace(b),g(b)}}function T(){if(f.logDebug("ATT.rtc.Call: disconnect"),na.on("error",J),"created"===va||"connecting"===va){if(f.logInfo("Canceling call.."),za=!0,null===da)return void f.logInfo("Call connecting not completed yet");f.logInfo("Call connecting completed. Sending cancel request"),Ca.cancelCall({callId:da,breed:ka,sessionId:la.sessionId,token:la.token,onSuccess:function(){f.logDebug("cancelCall: success"),f.logInfo("Successfully canceled call")},onError:function(a){f.logDebug("cancelCall: onError"),f.logError("Error canceling call"),f.logTrace(a),g(a)}})}else null!==da&&(f.logInfo("Disconnecting call..."),s("disconnecting"),Ca.disconnectCall({sessionId:la.sessionId,breed:ka,token:la.token,callId:da,onSuccess:function(){f.logDebug("disconnectCall: onSuccess"),f.logInfo("Successfully disconnected call")},onError:function(a){f.logDebug("disconnectCall: onError"),f.logError("Error disconnecting call"),f.logTrace(a),g(a)}}))}function U(){f.logDebug("ATT.rtc.Call: disconnectConference"),f.logInfo("Disconnecting Conference..."),s("disconnecting"),Ca.disconnectCall({sessionId:la.sessionId,token:la.token,breed:"conference",callId:da,onSuccess:function(){f.logDebug("disconnectCall: onSuccess"),f.logInfo("Successfully disconnected conference")},onError:function(a){f.logDebug("disconnectCall: onError"),f.logError("Error disconnecting conference"),f.logTrace(a),g(a)}})}function V(a){var b=!1;if(f.logDebug("ATT.rtc.Phone: validOperation"),f.logTrace("Operation",a),f.logTrace("State",va),!Ha.hasOwnProperty(a))throw new Error(a+" is not a valid operation");if(Ha[a].forEach(function(a){va===a&&(b=!0)}),!b)throw new Error("Cannot "+a+" call. The operation was called in invalid call state: "+va)}function W(){f.logDebug("ATT.rtc.Call: mute"),f.logInfo("Muting call...");try{i(!1),xa=!0,Ba.publish("muted",h())}catch(a){f.logError("Error muting call"),f.logTrace(a),g(a)}}function X(){f.logDebug("ATT.rtc.Call: unmute"),f.logInfo("Unmuting call...");try{i(!0),xa=!1,Ba.publish("unmuted",h())}catch(a){f.logError("Error unmuting call"),f.logTrace(a),g(a)}}function Y(a){var c,d;Fa=a,Ga=!0,f.logInfo("Creating offer for "+a),1===ATT["private"].holdResumeOpt?p():q(),ha.generateOffer({constraints:{OfferToReceiveAudio:!1,OfferToReceiveVideo:!1},onOfferCreated:function(a){return f.logDebug("peerConnection.generateOffer: onOfferCreated"),wa&&(a=b.createSdp(a).createInactiveSdp().getDescription()),a},onOfferReady:function(b){return f.logDebug("peerConnection.generateOffer: onOfferReady"),na.setLocalSdp(b),d=na.localSdp().getDescription(),f.logTrace("localSDP",d),c={description:d,sessionId:la.sessionId,token:la.token,breed:ka,callId:da,onSuccess:function(){f.logDebug(a+"Call: onSuccess"),f.logInfo("Successfully sent offer for "+a+" call"),r("modification-initiated"),Ba.publish("modification-in-progress",h())},onError:function(b){f.logDebug(a+"Call: onError"),f.logInfo("Error sending offer for "+a+" call"),f.logTrace(b),g(b)}},"move"===a?void Ca.moveCall(c):void Ca.holdCall(c)},onError:function(a){f.logDebug("peerConnection.createSdpOffer: onError"),f.logInfo("Error during create sdp offer"),f.logTrace(a),g(a)}})}function Z(){f.logDebug("ATT.rtc.Call: hold"),f.logInfo("Holding call..."),Y("hold")}function $(){f.logDebug("ATT.rtc.Call: move"),f.logInfo("Moving call..."),Y("move")}function _(){var a;f.logDebug("ATT.rtc.Call: resume"),f.logInfo("Creating offer for resume"),Fa="resume",Ga=!0,1===ATT["private"].holdResumeOpt?n():o(),ha.generateOffer({constraints:{OfferToReceiveAudio:!0,OfferToReceiveVideo:"video"===ia},onOfferCreated:function(a){return f.logDebug("peerConnection.generateOffer: onOfferCreated"),wa&&(a=b.createSdp(a).createResumeSdp().getDescription()),a},onOfferReady:function(b){f.logDebug("peerConnection.generateOffer: onOfferReady"),na.setLocalSdp(b),a=na.localSdp().getDescription(),f.logTrace("localDescription",a),Ca.resumeCall({description:a,sessionId:la.sessionId,token:la.token,callId:da,breed:ka,onSuccess:function(){f.logDebug("resumeCall: onSuccess"),f.logInfo("Successfully sent resume call offer"),r("modification-initiated"),Ba.publish("modification-in-progress",h())},onError:function(a){f.logDebug("resumeCall: onError"),f.logError("Error sending resume call offer"),f.logTrace(a),g(a)}})},onError:function(a){f.logDebug("peerConnection.createSdpOffer: onError"),f.logInfo("Error during create sdp offer"),f.logTrace(a),g(a)}})}function aa(){f.logDebug("ATT.rtc.Call: reject"),f.logInfo("Rejecting call..."),Aa=!0,Ca.rejectCall({callId:da,sessionId:la.sessionId,token:la.token,breed:ka,onSuccess:function(){f.logDebug("rejectCall: onSuccess"),f.logInfo("Successfully rejected the call")},onError:function(a){f.logDebug("rejectCall: onError"),f.logError("Error rejecting the call"),f.logTrace(a),g(a)}})}function ba(a){if(void 0===a||0===Object.keys(a).length)throw new Error("No options provided");if(void 0===a.input)throw new Error("No input provided");try{a.onToneSent=function(a){var b=h();b.tone=a.tone,b.timestamp=new Date(a.timeStamp),Ba.publish("tone-sent",b)},a.onToneSending=function(){Ba.publish("tone-sending",h())},ha.sendDTMFTone(a)}catch(b){f.logError("Error sending dtmf tone"),f.logTrace(b),g(b)}}function ca(a){if(f.logDebug("ATT.rtc.Call: transfer"),f.logInfo("Transferring call..."),f.logTrace(a),void 0===a||0===Object.keys(a).length||void 0===a.targetCallId)throw new Error("No targetCallId provided");Ca.transferCall({callId:da,breed:ka,sessionId:la.sessionId,token:la.token,targetCallId:a.targetCallId,transfereeSdp:na.remoteSdp().getDescription().sdp,success:function(){f.logDebug("transferCall: success"),f.logInfo("Successfully transferred the call"),"function"==typeof a.success&&a.success()},error:function(b){f.logDebug("transferCall: error"),f.logError("Error transferring the call"),f.logTrace(b),"function"==typeof a.error&&a.error(b)}})}f.logDebug("ATT.rtc.Call: Constructor");var da,ea,fa,ga,ha,ia,ja,ka,la,ma,na=this,oa={},pa={},qa=null,ra=null,sa=null,ta=null,ua=null,va=null,wa=!1,xa=!1,ya=[],za=!1,Aa=!1,Ba=b.createEventEmitter(),Ca=e.getRTCManager(),Da=ATT.errorDictionary,Ea=null,Fa=null,Ga=null,Ha={hold:["connected"],resume:["held"],move:["connected"],transfer:["held"],upgrade:["connected"],downgrade:["connected"],acceptMod:["connected","held"],rejectMod:["connected","held"],sendDTMFTone:["connected"]};if(void 0===a||0===Object.keys(a).length)throw new Error("No input provided");if(void 0===a.breed)throw new Error("No breed provided");if("call"===a.breed&&void 0===a.peer)throw new Error("No peer provided");if(void 0===a.type)throw new Error("No type provided");if(void 0===a.mediaType)throw new Error("No mediaType provided");if(void 0===a.pcConfiguration)throw new Error("No peer connection configuration provided");ka=a.breed,void 0===a.id?da=null:(da=a.id,K()),va="created",ea=a.peer,fa=a.index,ia=a.mediaType,ja=a.type,la=a.sessionInfo,ga=a.pcConfiguration,this.index=function(){return fa},this.pcConfiguration=function(){return ga},this.peer=function(){return ea},this.codec=function(){return ya},this.mediaType=function(){return ia},this.type=function(){return ja},this.breed=function(){return ka},this.state=function(){return va},this.held=function(){return wa},this.muted=function(){return xa},this.participants=function(){return pa},this.invitations=function(){return oa},this.sessionInfo=function(){return la},this.id=function(){return da},this.localSdp=function(){return qa},this.remoteSdp=function(){return ra},this.localStream=function(){return sa},this.remoteStream=function(){return ta},this.canceled=function(){return za},this.rejected=function(){return Aa},this.modifications=function(){return Ea},this.on=O,this.off=P,this.createEventData=h,this.setId=L,this.setLocalSdp=M,this.setRemoteSdp=N,this.addStream=t,this.removeStream=u,this.validateOperation=V,this.connect=Q,this.disconnect=T,this.disconnectConference=U,this.addParticipant=R,this.removeParticipant=S,this.mute=W,this.unmute=X,this.hold=Z,this.resume=_,this.move=$,this.reject=aa,this.transfer=ca,this.sendDTMFTone=ba,a.test&&(this.operation=function(){return Fa},this.generator=function(){return Ga},this.setState=r,this.setHeld=function(a){wa=a},this.setModifications=function(a){Ea=a},this.setOperation=function(a){Fa=a})}var b=ATT["private"].factories,c=ATT["private"]["enum"],d=ATT.utils,e=ATT["private"].rtcManager,f=ATT.logManager.createLogger("call");if(f.logDebug("Loading att.rtc.call..."),ATT["private"].holdResumeOpt=2,void 0===ATT.rtc)throw new Error("Cannot export Call. ATT.rtc is undefined");ATT.rtc.Call=a}(),function(){"use strict";function a(){function a(a,b){e.logDebug("ATT.rtc.Session: publishError");var c;"object"==typeof a&&a.hasOwnProperty("ErrorCode")?(c=a,a=c.ErrorCode):"object"==typeof b&&b.hasOwnProperty("ErrorCode")?(c=b,a=c.ErrorCode,b=void 0):"string"==typeof a?c=o.getSDKError(a):a instanceof Error&&(b=a,c=o.getSDKError("0000"),a="0000"),void 0===c&&(b=new Error("TODO: Error with error code "+a+" is not defined in the SDK error dictionary"),a="0001",c=o.getSDKError(a)),void 0!==b&&(b instanceof Error?c.AdditionalInformation=b.message:"string"==typeof b?c.AdditionalInformation=b:c.AdditionalInformation=JSON.stringify(b)),e.logInfo("Publishing SDK error "+a),l.publish("error",c)}function g(a){e.logDebug("ATT.rtc.Session: onInvitationReceived"),e.logInfo("On getting invitation"),e.logTrace("Call information",a);var b,d,f;return null!==n.pendingCall?void l.publish("notification",{from:a.from,mediaType:a.mediaType,type:a.type,timestamp:new Date,message:"Can only handle one incoming call at a time; ignoring the second incoming call."}):Object.keys(r).length>=2?void l.publish("notification",{from:a.from,mediaType:a.mediaType,type:a.type,timestamp:new Date,message:"Two calls already in progress, unable to handle a third incoming call."}):(d=n.createCall({breed:a.type,id:a.id,peer:a.from,type:c.CALL_TYPE.INCOMING,mediaType:a.mediaType}),void(void 0!==d&&(a.sdp&&(f=a.sdp,d.setRemoteSdp({sdp:f,type:"offer"})),b="call"===d.breed()?"call:incoming":"conference-invite",l.publish(b,{from:d.peer(),mediaType:d.mediaType(),codec:d.codec(),timestamp:new Date}))))}function h(a,b){e.logDebug("ATT.rtc.Session: off"),e.logTrace("Un-subscribing from event:",a),l.unsubscribe(a,b)}function i(a,b){if(e.logDebug("ATT.rtc.Session: on"),e.logTrace("Subscribing to session event: ",a),"ready"!==a&&"connecting"!==a&&"connected"!==a&&"updating"!==a&&"needs-refresh"!==a&&"notification"!==a&&"call:incoming"!==a&&"conference-invite"!==a&&"call:switched"!==a&&"disconnecting"!==a&&"disconnected"!==a&&"address-updated"!==a&&"all-calls-terminated"!==a&&"error"!==a)throw e.logError("Event "+a+" not defined"),new Error("Event "+a+" not defined");l.unsubscribe(a,b),l.subscribe(a,b,this)}function j(){var a,b=0;for(a in r)r.hasOwnProperty(a)&&b<r[a].index()&&(b=r[a].index());return b}function k(a,b){var c={to:b.createEventData(),timestamp:new Date};null!==a&&(c.from=a.createEventData()),l.publish("call:switched",c)}e.logDebug("ATT.rtc.Session: Constructor");var l,m,n=this,o=ATT.errorDictionary,p=null,q=null,r={};l=b.createEventEmitter(),m=d.getRTCManager(),this.timeout=null,this.e911Id=null,this.pendingCall=null,this.currentCall=null,this.timer=null,this.getSupportedAudioCodecs=function(){return f.getSupportedAudioCodecs()},this.getPCConfiguration=function(){return f.getPCConfiguration()},this.setPCConfiguration=function(a){f.setPCConfiguration(a)},this.resetPCConfiguration=function(a){f.resetPCConfiguration(a)},this.on=i.bind(this),this.off=h.bind(this),this.getToken=function(){return e.logDebug("ATT.rtc.Session: getToken"),e.logInfo("Getting the token"),e.logTrace("Token",q),q},this.getId=function(){return e.logDebug("ATT.rtc.Session: getId"),e.logInfo("Getting the session id"),e.logTrace("getId-Session Id",p),p},this.setId=function(a){return e.logDebug("ATT.rtc.Session: setId"),e.logInfo("Setting the session Id"),e.logTrace("setId-Session Id",a),p=a,null===a?(e.logInfo("Null session Id"),void l.publish("disconnected")):void l.publish("connected")},this.update=function(b){if(e.logDebug("ATT.rtc.Session: update"),e.logInfo("Updating the session object"),e.logTrace("update-options",b),void 0===b)throw e.logError("No options provided"),new Error("No options provided");if(void 0!==b.timeout&&"number"!=typeof b.timeout)throw e.logError("Error invalid Timeout"),new Error("Timeout is not a number.");l.publish("updating",b),q=b.token||q,this.e911Id=b.e911Id||this.e911Id,e.logDebug("Updating the session object successfully"),void 0!==b.timeout&&(b.timeout<6e4?this.timeout=b.timeout:this.timeout=b.timeout-6e4,null!==this.timer&&clearInterval(this.timer),this.timer=setInterval(function(){l.publish("needs-refresh"),m.refreshSession({sessionId:p,token:q,onSuccess:function(){e.logDebug("refreshSession: success"),e.logInfo("Successfully refreshed the session")},onError:function(b){e.logDebug("refreshSession: error"),e.logInfo("Error refreshing the session"),e.logTrace(b),a(b)}})},this.timeout))},this.connect=function(b){if(e.logDebug("ATT.rtc.Session: connect"),e.logTrace("connect-options",b),void 0===b||0===Object.keys(b).length)throw new Error("No options provided");if(void 0===b.token)throw new Error("No token provided");q=b.token,this.e911Id=b.e911Id,l.publish("connecting"),n=this,e.logInfo("Connect the session"),m.connectSession({token:b.token,e911Id:b.e911Id,onSessionConnected:function(a){e.logDebug("connectSession: onSessionConnected"),e.logTrace("Session Information",a),n.setId(a.sessionId),n.update({timeout:a.timeout})},onSessionReady:function(a){a.timeStamp=new Date,e.logDebug("connectSession: onSessionReady"),e.logTrace("onSessionReady-data",a),l.publish("ready",a),m.on("invitation-received:"+p,g)},onError:function(b){e.logDebug("connectSession: onError"),e.logError("Error during connectSession"),e.logError("Error during connectSession"),e.logTrace("connectSession: error",b),a("2000",b)}})},this.disconnect=function(){e.logDebug("ATT.rtc.Session: disconnect"),l.publish("disconnecting"),clearInterval(this.timer),e.logInfo("Disconnect the session"),m.disconnectSession({sessionId:n.getId(),token:n.getToken(),e911Id:n.e911Id,onSessionDisconnected:function(){e.logDebug("disconnectSession: onSessionDisconnected"),n.setId(null)},onError:function(b){e.logDebug("disconnectSession: onError"),e.logError("Error during disconnectSession"),e.logTrace("disconnectSession: error",b),n.setId(null),a("3000",b)}})},this.addCall=function(a){e.logDebug("ATT.rtc.Session: addCall"),e.logInfo("Adding a call in the calls array"),e.logTrace("callId",a.id()),e.logTrace("Before",r),r[a.id()]=a,e.logTrace("After",r)},this.createCall=function(a){e.logDebug("ATT.rtc.Session: createCall"),e.logInfo("Creating a new call"),e.logTrace("CreateCall-options",a);var b=new ATT.rtc.Call(ATT.utils.extend(a,{pcConfiguration:f.getPCConfiguration(),index:j()+1,sessionInfo:{sessionId:this.getId(),token:this.getToken()}}));return e.logTrace("call.peer()",b.peer()),e.logTrace("call object",b),b.on("connected",function(){e.logDebug("call.on: connected"),null!==n.currentCall&&(e.logInfo("Switching the calls..."),e.logTrace("From",n.currentCall.peer()),e.logTrace("To",n.pendingCall.peer()),k(n.currentCall,n.pendingCall)),n.currentCall=n.pendingCall,n.pendingCall=null,n.addCall(n.currentCall)}),b.on("error",function(){e.logDebug("call.on: error"),b===n.pendingCall&&(e.logInfo("Deleting pending call"),e.logTrace("session.pendingCall.peer",n.pendingCall.peer()),e.logTrace("session.pendingCall",n.pendingCall),n.pendingCall=null)}),this.pendingCall=b,e.logTrace("call.id",b.id()),e.logTrace("call object",b),b},this.getCall=function(a){return e.logDebug("ATT.rtc.Session: getCall"),e.logInfo("Getting call by id"),e.logTrace("callId",a),r[a]},this.getCalls=function(){return e.logDebug("ATT.rtc.Session: getCalls"),e.logInfo("Getting all calls"),e.logTrace("calls",Object.keys(r)),r},this.switchTo=function(a){if(e.logDebug("ATT.rtc.Session: switchTo"),e.logInfo("Switching to call by callId"),e.logTrace("callId",a),void 0===a)throw e.logError("You must pass a valid call id"),new Error("You must pass a valid call id");if(void 0===r[a])throw e.logError("Cannot find call with id "+a),new Error("Cannot find call with id "+a);r[a]!==this.currentCall&&(k(this.currentCall,r[a]),e.logInfo("Setting current call"),this.currentCall=r[a]),e.logTrace("currentCall.peer",this.currentCall.peer()),e.logTrace("currentCall",this.currentCall),"held"===this.currentCall.state()&&this.currentCall.autoresume&&(e.logInfo("resuming current call"),this.currentCall.resume(),this.currentCall.autoresume=!1)},this.terminateCalls=function(){e.logDebug("ATT.rtc.Session: terminateCalls"),e.logInfo("Terminating all the calls");var a;for(a in r)r.hasOwnProperty(a)&&(e.logTrace("callId",a),e.logTrace("call.peer",r[a].peer()),r[a].disconnect())},this.deleteCall=function(a){if(e.logDebug("ATT.rtc.Session: deleteCall"),e.logInfo("Deleting a call by callId"),e.logTrace("callId",a),void 0===a)throw e.logError("Cannot delete call as no call id provided."),new Error("Cannot delete call as no call id provided.");if(void 0===r[a])throw e.logError("Call with id "+a+" not found."),new Error("Call with id "+a+" not found.");e.logInfo("Call deleted with peer "+r[a].peer()),e.logTrace("Call deleted",r[a]),delete r[a],0===Object.keys(r).length&&(e.logInfo("All calls deleted from ATT.rtc.Session"),l.publish("all-calls-terminated"))},this.deletePendingCall=function(){e.logDebug("ATT.rtc.Session: deletePendingCall"),e.logInfo("Deleting pending call"),null!==this.pendingCall&&(e.logTrace("pendingCall.peer",this.pendingCall.peer()),e.logTrace("pendingCall",this.pendingCall),this.pendingCall=null)},this.deleteCurrentCall=function(){e.logDebug("ATT.rtc.Session: deleteCurrentCall"),e.logInfo("Deleting current call"),null!==this.currentCall&&(e.logTrace("currentCall.peer",this.currentCall.peer()),e.logTrace("currentCall",this.currentCall),this.deleteCall(this.currentCall.id()),this.currentCall=null)},this.associateToken=function(a){e.logDebug("ATT.rtc.Session: associateToken"),e.logInfo("Associating Token"),e.logTrace("associateToken.options",a),m.associateToken(a)},this.associateE911Id=function(b){e.logDebug("ATT.rtc.Session: associateE911Id"),e.logInfo("Associating E911 ID"),e.logTrace("associateE911Id.options",b),m.associateE911Id(ATT.utils.extend(b,{sessionId:this.getId(),token:this.getToken(),onSuccess:function(){e.logDebug("associateE911Id: onSuccess"),e.logInfo("Successfully associated E911 ID"),l.publish("address-updated",n.createEventData())},onError:function(b){e.logDebug("associateE911Id: onError"),e.logError("Error during associating E911 ID"),e.logTrace(b),a("2050",b)}}))},this.getVersion=function(){return f.getVersion()},this.createEventData=function(){var a={};return a.timestamp=new Date,null!==p&&(a.sessionId=p),a}}var b=ATT["private"].factories,c=ATT["private"]["enum"],d=ATT["private"].rtcManager,e=ATT.logManager.createLogger("session"),f=ATT["private"].config.app;if(e.logDebug("Loading att.rtc.session..."),void 0===ATT.rtc)throw new Error("Cannot export Session. ATT.rtc is undefined");ATT.rtc.Session=a}(),function(){"use strict";function a(a){function e(a,b){Ua.push({event:a,data:b}),d.logInfo("Publishing event "+a),d.logTrace(a,b),Pa.publish(a,b)}function f(a,b){return a instanceof Error?void g("0000",a):(void 0!==b&&(b instanceof Error?a.AdditionalInformation=b.message:"string"==typeof b?a.AdditionalInformation=b:a.AdditionalInformation=JSON.stringify(b)),a.timeStamp=new Date,void e("error",a))}function g(a,b){d.logDebug("ATT.rtc.Phone: publishSDKError");var c=Ra.getSDKError(a);void 0===c&&(c=Ra.getSDKError("0001"),b=new Error("TODO: Error with error code "+a+" is not defined in the SDK error dictionary")),d.logInfo("Publishing SDK error "+a),f(c,b)}function h(a){return!(a instanceof HTMLMediaElement)}function i(a){void 0!==a.localMedia&&(Sa=a.localMedia),void 0!==a.localMedia&&(Ta=a.remoteMedia)}function j(a,b){var c;if("local"===a&&(c=Sa),"remote"===a&&(c=Ta),h(c))throw new Error("Failed to play "+a+" media as `"+a+"Media` element is not setup.");d.logInfo("Playing "+a+" media..."),c.src=window.URL.createObjectURL(b),"local"===a&&c.setAttribute("muted","true"),c.play()}function k(a){j("local",a.local),j("remote",a.remote)}function l(a){var b;if("local"===a&&(b=Sa),"remote"===a&&(b=Ta),null!==b){if(h(b))throw new Error("Failed to stop "+a+" media as `"+a+"Media` element is not setup.");d.logInfo("Stopping "+a+" media..."),b.pause(),b.src=""}}function m(){l("local"),l("remote")}function n(a,b,c){getUserMedia({audio:!0,video:"video"===a},function(a){Oa=a,b.call(null,Oa)},c)}function o(){void 0!==Oa&&(d.logInfo("Releasing user media"),Oa.getTracks().forEach(function(a){a.stop()}))}function p(a){return d.logDebug("ATT.rtc.Phone: onError"),d.logTrace("data",a),404===a.HttpStatusCode?(d.logError("session:expired by ATT.rtc.Phone"),void e("session:expired",Qa.createEventData())):502===a.HttpStatusCode||503===a.HttpStatusCode?(d.logError("gateway:unreachable by ATT.rtc.Phone"),void e("gateway:unreachable",Qa.createEventData())):(d.logError("error event by ATT.rtc.Phone"),void f(a))}function q(a){var b,c;return null!==Qa.pendingCall&&a.id()===Qa.pendingCall.id()||null!==Qa.currentCall&&a.id()===Qa.currentCall.id()?(d.logInfo("Foreground call event fired"),Qa.currentCall&&a.id()===Qa.currentCall.id()?(d.logInfo("Deleting current call"),Qa.deleteCurrentCall()):Qa.pendingCall&&a.id()===Qa.pendingCall.id()&&(d.logInfo("Deleting pending call"),d.logTrace(Qa.pendingCall.peer(),Qa.pendingCall),Qa.deletePendingCall()),b=Qa.getCalls(),c=Object.keys(b),m(),d.logInfo("Remaining calls: "+c.length),0===c.length?void o():(d.logInfo("Setting background call as current call"),void Qa.switchTo(c[0]))):(d.logInfo("Background call event fired"),d.logInfo("Deleting background call"),d.logTrace(a.peer(),a),Qa.deleteCall(a.id()),b=Qa.getCalls(),c=Object.keys(b),0===c.length?void m():void 0)}function r(a,b){return d.logDebug("call.on: disconnected"),a.off("disconnected",r),q(a),null!==Qa.currentCall&&Qa.currentCall.id()!==a.id()&&(b.background=!0),"conference"===a.breed()?(d.logInfo("conference:ended event by ATT.rtc.Phone"),d.logTrace("data",b),void e("conference:ended",b)):(d.logInfo("call:disconnected event by ATT.rtc.Phone"),d.logTrace("data",b),void e("call:disconnected",b))}function s(a,b){return a.off("canceled",s),q(a),"conference"===a.breed()?(d.logDebug("conference.on: canceled"),d.logInfo("conference:canceled event by ATT.rtc.Phone"),d.logTrace("data",b),void e("conference:canceled",b)):(d.logDebug("call.on: canceled"),d.logInfo("call:canceled event by ATT.rtc.Phone"),d.logTrace("data",b),void e("call:canceled",b))}function t(a,b){return a.off("rejected",t),("conference"!==a.breed()||c.CALL_TYPE.OUTGOING!==a.type())&&q(a),"conference"===a.breed()?(d.logDebug("conference.on: invitation-rejected"),d.logInfo("conference:invitation-rejected event by ATT.rtc.Phone"),d.logTrace("data",b),void e("conference:invitation-rejected",b)):(d.logDebug("call.on: rejected"),d.logInfo("call:rejected event by ATT.rtc.Phone"),d.logTrace("data",b),void e("call:rejected",b))}function u(a){d.logDebug("call.on: muted"),d.logInfo("call:muted event by ATT.rtc.Phone"),e("call:muted",a)}function v(a){d.logDebug("call.on: unmuted"),d.logInfo("call:unmuted event by ATT.rtc.Phone"),e("call:unmuted",a)}function w(a){var b=Qa.currentCall;return m(),"conference"===b.breed()?(d.logDebug("conference.on: held"),d.logInfo("conference:held event by ATT.rtc.Phone"),d.logTrace("data",a),void e("conference:held",a)):(d.logDebug("call.on: held"),d.logInfo("call:held event by ATT.rtc.Phone"),d.logTrace("data",a),void e("call:held",a))}function x(a){var b=Qa.currentCall;return k({local:b.localStream(),remote:b.remoteStream()}),"conference"===b.breed()?(d.logDebug("conference.on: resumed"),d.logInfo("conference:resumed event by ATT.rtc.Phone"),d.logTrace("data",a),void e("conference:resumed",a)):(d.logDebug("call.on: resumed"),d.logInfo("call:resumed event by ATT.rtc.Phone"),d.logTrace("data",a),void e("call:resumed",a))}function y(a){var b=Qa.currentCall;d.logDebug("call.on: moved"),d.logInfo("call:moved event by ATT.rtc.Phone"),d.logTrace("data",a),b.off("moved",y),m(),e("call:moved",a)}function z(a){d.logDebug("call.on: connected"),d.logInfo("call:connected event by ATT.rtc.Phone"),d.logTrace("data",a),e("call:connected",a)}function A(a,b){return d.logDebug("call.on: stream-added"),d.logTrace(b),j("remote",b.stream),"connecting"===a.state()&&"call"===a.breed()?(d.logInfo("Got early media"),d.logInfo("call:ringback-provided event by ATT.rtc.Phone"),void e("call:ringback-provided",a.createEventData())):"created"===a.state()?(d.logInfo("media:established event by ATT.rtc.Phone"),void e("media:established",a.createEventData())):void("connected"===a.state()&&(d.logInfo("media:established event by ATT.rtc.Phone"),e("media:established",a.createEventData())))}function B(a){d.logDebug("call.on: modification-in-progress"),d.logInfo("call:modification-in-progress event from Att.rtc.Phone"),d.logTrace("data",a),e("call:modification-in-progress",a)}function C(a,b){d.logDebug("call.on: state-changed"),d.logInfo("call:state-changed event from Att.rtc.Phone"),d.logTrace("data",b),null!==Qa.currentCall&&Qa.currentCall.id()!==a.id()&&(b.background=!0),e("call:state-changed",b)}function D(a,b){d.logDebug("call.on: notification"),d.logInfo("notification event by ATT.rtc.Phone"),("conference"!==a.breed()||c.CALL_TYPE.OUTGOING!==a.type())&&q(a),e("notification",b)}function E(a){d.logDebug("call.on: transferring"),d.logInfo("call:transferring event by ATT.rtc.Phone"),e("call:transferring",a)}function F(a){d.logDebug("call.on: transferred"),d.logInfo("call:transferred event by ATT.rtc.Phone"),e("call:transferred",a)}function G(a){d.logDebug("ATT.rtc.Phone: onSessionReady"),d.logTrace("data",a),Qa.off("ready",G),e("session:ready",a)}function H(a){d.logDebug("ATT.rtc.Phone: onSessionDisconnected"),d.logTrace("data",a),Qa.off("ready",G),Qa.off("disconnected",H),e("session:disconnected",a)}function I(a){e("dtmf:tone-sending",a)}function J(a){e("dtmf:tone-sent",a)}function K(a){return a=a.replace(/\s/g,""),a.indexOf("sip:")>-1||a.indexOf("tel:")>-1?!0:!1}function L(){return Qa}function M(){return Ua}function N(){return Ua[Ua.length-1]}function O(a){d.logDebug("ATT.rtc.Phone: cleanPhoneNumber");try{return d.logInfo("Attempting to clean the phone number "+a),ATT.phoneNumber.cleanPhoneNumber(a)}catch(b){d.logError("Error during cleanPhoneNumber"),d.logTrace(b),g("3810",b)}}function P(a){d.logDebug("ATT.rtc.Phone: formatNumber");try{return d.logInfo("Attempting to format the phone number "+a),ATT.phoneNumber.formatNumber(a)}catch(b){d.logError("Error during formatNumber"),d.logTrace(b),g("3820",b)}}function Q(a){if(void 0===a)return null;var b,c={};try{a.indexOf(";")>-1&&(b=a.split(";"),b.forEach(function(b,d){if(0===d)a=b;else if(b.indexOf("=")>-1){var e=b.split("=");e.length>0&&(c[e[0]]=2===e.length?e[1]:"")}})),a.indexOf(":")>-1&&(b=a.split(":"),c.protocol=b.length>0?b[0]:"",a=b.length>=2?b[1]:"",c.port=b.length>=3?b[2]:""),b=a.split("@"),c.callerId=b.length>0?b[0]:"",c.domain=b.length>=2?b[1]:""}catch(e){d.logError("Error during getCallerInfo"),d.logTrace(e),g("3830",e)}return c}function R(a,b){return d.logDebug("ATT.rtc.Phone: on"),d.logInfo("Subscribing to phone event: "+a),void 0===a||"function"!=typeof b?void g("4901"):("session:ready"!==a&&"session:disconnected"!==a&&"session:call-switched"!==a&&"session:expired"!==a&&"gateway:unreachable"!==a&&"notification"!==a&&"dialing"!==a&&"answering"!==a&&"call:incoming"!==a&&"call:connecting"!==a&&"call:connected"!==a&&"call:disconnecting"!==a&&"call:disconnected"!==a&&"call:muted"!==a&&"call:unmuted"!==a&&"call:held"!==a&&"call:resumed"!==a&&"call:canceled"!==a&&"call:rejected"!==a&&"call:moved"!==a&&"call:transferring"!==a&&"call:transferred"!==a&&"address-updated"!==a&&"call:ringback-provided"!==a&&"media:captured"!==a&&"media:established"!==a&&"conference:invitation-received"!==a&&"conference:joining"!==a&&"conference:invitation-sending"!==a&&"conference:invitation-rejected"!==a&&"conference:connecting"!==a&&"conference:invitation-sent"!==a&&"conference:invitation-accepted"!==a&&"conference:participant-removed"!==a&&"conference:held"!==a&&"conference:resumed"!==a&&"conference:disconnecting"!==a&&"conference:ended"!==a&&"conference:canceled"!==a&&"conference:connected"!==a&&"warning"!==a&&"error"!==a&&"call:modification-in-progress"!==a&&"call:media-modification"!==a&&"call:state-changed"!==a&&"dtmf:tone-sending"!==a&&"dtmf:tone-sent"!==a&&"connectivity:on"!==a&&"connectivity:off"!==a&&g("4902"),Pa.unsubscribe(a,b),void Pa.subscribe(a,b,this))}function S(a){return void 0===a?void g("5101"):h(a.localMedia)?void g("5111"):h(a.remoteMedia)?void g("5112"):void i(a)}function T(a){if(void 0===a)return void g("5001");if(void 0===a.mediaType)return void g("5011");if(-1===["audio","video"].indexOf(a.mediaType))return void g("5012");try{n(a.mediaType,function(a){e("media:captured",a)},function(a){g("0020",a)})}catch(b){g("5000",b)}}function U(){d.logDebug("ATT.rtc.Phone: getCalls");var a,b,c,e,f=Qa.getCalls(),g=[];d.logInfo("Getting list of calls...");for(a in f)if(f.hasOwnProperty(a)){if(d.logTrace("call id",a),b={index:f[a].index(),state:f[a].state(),breed:f[a].breed(),type:f[a].type()},"conference"===f[a].breed()){b.participants=[],e=f[a].participants(),d.logTrace("Participants",Object.keys(e).length);for(c in e)e.hasOwnProperty(c)&&(d.logTrace("participant",c),b.participants.push(e[c]))}else b.peer=f[a].peer();g.push(b)}return d.logTrace("Call List",g),g}function V(a){if(d.logDebug("ATT.rtc.Phone: login"),d.logTrace("options",a),!Va)return void g("0002");if(void 0===a)return void g("2001");if(void 0===a.token)return void g("2002");if(null!==Qa.getId())return void g("2003");try{Qa.on("ready",G),d.logInfo("logging in..."),Qa.connect(a)}catch(b){d.logError("Error during login"),d.logTrace(b),g("2000",b)}}function W(a){if(d.logDebug("ATT.rtc: associateAccessToken"),d.logInfo("Associating access token  Domain"),!Va)throw new Error("Device is offline");if(void 0===a||0===Object.keys(a).length)throw new Error("No options provided");if(void 0===a.userId)throw new Error("No userId provided");if(void 0===a.token)throw new Error("No token provided");if(void 0===a.success)throw new Error("No success callback provided");if(void 0===a.error)throw new Error("No error callback provided");Qa.associateToken(a)}function X(a){if(d.logDebug("ATT.rtc.Phone: associateE911Id"),void 0===a)return void g("2051");if("string"!=typeof a.e911Id)return void g("2052");if(null===Qa.getId())return void g("2053");try{Qa.on("address-updated",function(a){d.logDebug("session.on: address-updated"),d.logInfo("address-updated event by ATT.rtc.Phone"),e("address-updated",a)}),d.logTrace(Qa.getId(),Qa),d.logTrace("E911 Id",Qa.e911Id),d.logInfo("Associating E911 Id..."),Qa.associateE911Id(a)}catch(b){d.logInfo("Error during associateE911Id"),d.logTrace(b),g("2050",b)}}function Y(){function a(){d.logDebug("session.on: all-calls-terminated"),d.logInfo("All calls were terminated successfully"),Qa.off("all-calls-terminated",a),d.logInfo("logging out..."),Qa.disconnect()}if(d.logDebug("ATT.rtc.Phone: logout"),!Va)return void g("0002");if(Qa.on("error",H),null===Qa.getId())return void g("2101");try{d.logInfo("logging out..."),Qa.on("disconnected",H),
null!==Qa.pendingCall&&(d.logInfo("Pending call exist. Deleting pending call..."),d.logTrace(Qa.pendingCall.peer(),Qa.pendingCall),Qa.deletePendingCall()),Object.keys(Qa.getCalls()).length>0?(d.logInfo("Active calls exist. Attempting to disconnect active calls..."),Qa.on("all-calls-terminated",a),Qa.terminateCalls()):(d.logInfo("logging out..."),Qa.disconnect())}catch(b){d.logError("Error during logout"),d.logTrace(b),g("2100",b)}}function Z(a,b,c,e){try{j("local",b),d.logTrace("localStream",b),a.addStream(b),d.logInfo("Connecting..."),a.connect(),c()}catch(f){d.logError("Unknown exception during phone.connectCall."),d.logTrace(f),e(f)}}function $(a,b,e,f){return d.logDebug("ATT.rtc.Phone: connectCall"),a.on("stream-added",A.bind(null,a)),"object"==typeof f?void Z(a,f,b,e):(void 0===f&&(f=a.mediaType()),d.logInfo("Attempting to get user media"),void n(f,function(c){d.logDebug("getUserMedia: onSuccess"),d.logInfo("Got local user media"),Z(a,c,b,e)},function(a){d.logDebug("getUserMedia: onError"),d.logError("Error during getUserMedia"),null!==Qa.pendingCall&&c.CALL_TYPE.INCOMING===Qa.pendingCall.type()&&ha(),g("0020",a)}))}function _(a){var b;i({localMedia:a.localMedia,remoteMedia:a.remoteMedia});try{e("dialing",{to:a.destination,mediaType:a.mediaType,timestamp:new Date}),d.logInfo("Creating new call..."),b=Qa.createCall({peer:a.destination,breed:"call",type:c.CALL_TYPE.OUTGOING,mediaType:a.mediaType,localMedia:a.localMedia,remoteMedia:a.remoteMedia}),d.logTrace(b.peer(),b),b.on("connecting",function(a){d.logDebug("call.on: connecting"),d.logInfo("call:connecting event by ATT.rtc.Phone"),d.logTrace("data",a),e("call:connecting",a)}),b.on("rejected",t.bind(null,b)),b.on("connected",z),b.on("held",w),b.on("resumed",x),b.on("moved",y),b.on("disconnected",r.bind(null,b)),b.on("modification-in-progress",B),b.on("state-changed",C.bind(null,b)),b.on("notification",D.bind(null,b)),b.on("error",p),b.on("media-modification",function(a){d.logDebug("call.on: media-modification"),d.logInfo("call:media-modification event by ATT.rtc.Phone"),d.logTrace("data",a),e("call:media-modification",a)}),d.logInfo("Dialing..."),$(b,function(){d.logDebug("ATT.rtc.Phone: connectCall: success"),d.logDebug("Successfully connected call with media stream")},function(a){d.logDebug("ATT.rtc.Phone: connectCall: error"),d.logError("Error during connectCall"),d.logTrace(a),g("2200",a)},a.localStream||a.mediaType)}catch(f){d.logError("Error during dial"),d.logTrace(f),g("2200",f)}}function aa(a){return d.logDebug("ATT.rtc.Phone: dial"),d.logInfo("Dialing a call.."),d.logTrace("options",a),Va?void 0===a?void g("2201"):"string"==typeof a.destination&&0<a.destination.length?K(a.destination)?void g("2212"):a.destination.split("@").length>2?void g("2213"):void 0!==a.mediaType&&-1===["audio","video"].indexOf(a.mediaType)?void g("2221"):void 0!==a.localMedia&&h(a.localMedia)?void g("2231"):void 0!==a.remoteMedia&&h(a.remoteMedia)?void g("2232"):null===Qa.getId()?void g("2241"):Qa.pendingCall?void g("2251"):null!==Qa.currentCall?void g("2252"):void _(a):void g("2211"):void g("0002")}function ba(a){function b(){d.logDebug("ATT.rtc.Phone: dialSecondCall"),c.off("held",b),d.logInfo("Dialing second call..."),_(a)}d.logDebug("ATT.rtc.Phone: addCall"),d.logTrace("options",a);var c;if(Va){if(void 0===a)return void g("3901");if(void 0===a.destination)return void g("3911");if(K(a.destination))return void g("3912");if(a.destination.split("@").length>2)return void g("3913");if(void 0!==a.mediaType&&"audio"!==a.mediaType&&"video"!==a.mediaType)return void g("3921");if(void 0!==a.localMedia&&h(a.localMedia))return void g("3931");if(void 0!==a.remoteMedia&&h(a.remoteMedia))return void g("3932");if(null===Qa.getId())return void g("3941");if(null===Qa.currentCall)return void g("3951");if(2<=U().length)return void g("3961");try{if(c=Qa.currentCall,d.logInfo("Putting existing call on hold"),"held"!==c.state())return c.on("held",b),c.hold(),void(c.autoresume=!0);b()}catch(e){d.logError("Error during hold current call"),d.logTrace(e),g("3900",e)}}}function ca(a,b){d.logDebug("ATT.rtc.Phone: answerCall"),d.logTrace("options",b),e("answering",{from:a.peer(),mediaType:a.mediaType(),codec:a.codec(),timestamp:new Date}),a.on("connecting",function(a){d.logDebug("call.on: connecting"),d.logInfo("call:connecting event by ATT.rtc.Phone"),d.logTrace("data",a),e("call:connecting",a)}),a.on("connected",z),a.on("held",w),a.on("resumed",x),a.on("moved",y),a.on("notification",D.bind(null,a)),a.on("modification-in-progress",B),a.on("media-modification",function(a){d.logDebug("call.on: media-modification"),d.logInfo("call:media-modification event by ATT.rtc.Phone"),d.logTrace("data",a),e("call:media-modification",a)}),a.on("state-changed",C.bind(null,a)),a.on("error",p),d.logInfo("Answering..."),$(a,function(){d.logDebug("ATT.rtc.Phone: connectCall: success"),d.logDebug("Successfully connected call with media stream")},function(a){d.logDebug("ATT.rtc.Phone: connectCall: error"),d.logError("Error during connect"),d.logTrace(a),g("2300",a)},b.localStream)}function da(a){function b(){d.logDebug("ATT.rtc.Phone: answerSecondCall"),d.logInfo("Answering second call"),c="end"===a.action?"disconnected":"held",f.off(c,b),ca(e,a)}d.logDebug("ATT.rtc.Phone: answer"),d.logTrace("options",a);var c,e,f;if(!Va)return void g("0002");if(void 0===a)return void g("2301");if(void 0!==a.localMedia&&h(a.localMedia))return void g("2311");if(void 0!==a.remoteMedia&&h(a.remoteMedia))return void g("2312");if(i({localMedia:a.localMedia,remoteMedia:a.remoteMedia}),null===Qa.getId())return void g("2321");if(e=Qa.pendingCall,null===e)return void g("2331");try{if(f=Qa.currentCall,null!==f){if(d.logTrace(f.peer(),f),d.logInfo("There is an existing call"),"hold"!==a.action&&"end"!==a.action)return void g("2341");if("hold"===a.action){if("held"!==f.state())return d.logInfo("Putting the current call on hold"),f.on("held",b),f.hold(),void(f.autoresume=!0);b(e,a,!0)}return void("end"===a.action&&(d.logInfo("Ending the current call"),f.on("disconnected",b.bind(null,f)),f.disconnect()))}void 0!==a.action&&d.logWarning("There is no current call. Action `"+a.action+"` will be ignored"),ca(e,a)}catch(j){d.logError("Error during answer"),d.logTrace(j),g("2300",j)}}function ea(){d.logDebug("ATT.rtc.Phone: hangup");var a;if(!Va)return void g("0002");if(null===Qa.getId())return void g("2401");if(a=Qa.currentCall,null===a||null===a.id())return void g("2402");try{d.logTrace(a.peer(),a),a.on("disconnecting",function(a){d.logDebug("call.on: disconnecting"),d.logInfo("call:disconnecting event by ATT.rtc.Phone"),d.logTrace("data",a),e("call:disconnecting",a)}),d.logInfo("Hanging up..."),a.disconnect()}catch(b){d.logError("Error during hangup"),d.logTrace(b),g("2400",b)}}function fa(){d.logDebug("Att.rtc.Phone: cancel");var a;if(!Va)return void g("0002");if(null===Qa.getId())return void g("2901");if(a=Qa.pendingCall,null===a)return void g("2902");try{d.logTrace(a.peer(),a),a.on("canceled",s.bind(null,a)),d.logInfo("Canceling..."),a.disconnect()}catch(b){d.logError("Error during cancel"),d.logTrace(b),g("2900",b)}}function ga(a){d.logDebug("ATT.rtc.Phone: setupStartConferenceEvents"),d.logTrace("options",a);var b;a.breed="conference",a.type=c.CALL_TYPE.OUTGOING,b=Qa.createCall(a),b.on("held",w),b.on("resumed",x),b.on("error",p),b.on("connected",function(a){d.logDebug("conference.on: connected"),d.logInfo("conference:connected event by ATT.rtc.Phone"),d.logTrace("data",a),Pa.publish("conference:connected",a)}),b.on("response-pending",function(a){d.logDebug("conference.on: response-pending"),d.logInfo("conference:invitation-sent event by ATT.rtc.Phone"),d.logTrace("data",a),Pa.publish("conference:invitation-sent",a)}),b.on("invite-accepted",function(a){d.logDebug("conference.on: invite-accepted"),d.logInfo("conference:invitation-accepted event by ATT.rtc.Phone"),d.logTrace("data",a),Pa.publish("conference:invitation-accepted",a)}),b.on("rejected",t.bind(null,b)),b.on("notification",D.bind(null,b)),b.on("participant-removed",function(a){d.logDebug("conference.on: participant-removed"),d.logInfo("conference:participant-removed event by ATT.rtc.Phone"),d.logTrace("data",a),Pa.publish("conference:participant-removed",a)}),b.on("state-changed",C.bind(null,b)),b.on("disconnected",r.bind(null,b)),d.logInfo("Starting conference..."),$(b,function(){d.logDebug("ATT.rtc.Phone: connectCall: success"),d.logDebug("Successfully connected conference with media stream")},function(a){d.logDebug("ATT.rtc.Phone: connectCall: error"),d.logError("Error during connectCall"),d.logTrace(a),g("3100",a)},a.localStream||a.mediaType)}function ha(){d.logDebug("Att.rtc.Phone: reject");var a;if(!Va)return void g("0002");if(null===Qa.getId())return void g("3001");if(a=Qa.pendingCall,null===a||null===a.id())return void g("3002");try{a.on("rejected",t.bind(null,a)),d.logInfo("Rejecting..."),a.reject()}catch(b){d.logError("Error during reject"),d.logTrace(b),g("3000",b)}}function ia(a){function b(e){d.logDebug("ATT.rtc.Phone: startSecondConference"),Pa.publish("conference:held",e),c.off("held",b),d.logInfo("Starting second conference..."),ga(a)}d.logDebug("ATT.rtc.Phone: startConference"),d.logTrace("options",a);var c;if(!Va)return void g("0002");if(void 0===a||0===Object.keys(a).length)return d.logError("No options provided"),void g("3101");if(void 0===a.mediaType||"audio"!==a.mediaType&&"video"!==a.mediaType)return d.logError("mediaType not provided"),void g("3111");if(void 0!==a.localMedia&&h(a.localMedia))return d.logError("localMedia not provided"),void g("3121");if(void 0!==a.remoteMedia&&h(a.remoteMedia))return d.logError("remoteMedia not provided"),void g("3122");if(null===Qa.getId())return d.logError("Cannot start session. user is not logged in"),void g("3131");if(2<=this.getCalls().length)return void g("3961");i({localMedia:a.localMedia,remoteMedia:a.remoteMedia});try{if(c=Qa.currentCall,null!==c)return d.logTrace(c.peer(),c),d.logInfo("There is an existing conference"),"held"===c.state()||"hold"===c.state()?void b():(d.logInfo("Putting the current conference on hold"),c.on("held",b),c.hold(),void(c.autoresume=!0));ga(a)}catch(e){d.logError("Error during start conference"),d.logTrace(e),g("3100",e)}}function ja(a,b){d.logDebug("ATT.rtc.Phone: setupJoinConferenceEvents"),d.logTrace("options",b),Pa.publish("conference:joining",{from:a.peer(),mediaType:a.mediaType(),codec:a.codec(),timestamp:new Date}),a.on("held",w),a.on("state-changed",C.bind(null,a)),a.on("error",p),a.on("connecting",function(a){d.logDebug("conference.on: connecting"),d.logInfo("conference:connecting event by ATT.rtc.Phone"),d.logTrace("data",a),Pa.publish("conference:connecting",a)}),a.on("connected",function(a){d.logDebug("conference.on: connected"),d.logInfo("conference:connected event by ATT.rtc.Phone"),d.logTrace("data",a),Pa.publish("conference:connected",a)}),a.on("notification",D.bind(null,a)),d.logInfo("Joining conference..."),$(a,function(){d.logDebug("ATT.rtc.Phone: connectCall: success"),d.logDebug("Successfully connected conference with media stream")},function(a){d.logDebug("ATT.rtc.Phone: connectCall: error"),d.logError("Error during connectCall"),d.logTrace(a),g("3200",a)},b.localStream)}function ka(){if(d.logDebug("ATT.rtc.Phone: rejectConference"),!Va)return void g("0002");if(null===Qa.getId())return void g("3301");if(null===Qa.pendingCall)return void g("3302");try{var a=Qa.pendingCall;d.logTrace(a.peer(),a),a.on("rejected",t.bind(null,a)),d.logInfo("Rejecting conference invite..."),a.reject()}catch(b){d.logError("Error during reject conference"),d.logTrace(b),g("3300",b)}}function la(a){function b(){d.logDebug("ATT.rtc.Phone: joindSecondConference"),d.logInfo("Joining second conference"),c="held","end"===a.action&&(c="disconnected"),j.off(c,b),ja(f,a)}d.logDebug("ATT.rtc.Phone: joinConference"),d.logTrace("options",a);var c,e,f,j;if(!Va)return void g("0002");if(void 0===a)return void g("3201");if(void 0!==a.localMedia&&h(a.localMedia))return d.logError("localMedia not provided"),void g("3211");if(void 0!==a.remoteMedia&&h(a.remoteMedia))return d.logError("remoteMedia not provided"),void g("3212");if(null===Qa.getId())return void g("3221");if(null===Qa.pendingCall||"conference"!==Qa.pendingCall.breed())return void g("3231");i({localMedia:a.localMedia,remoteMedia:a.remoteMedia}),f=Qa.pendingCall;try{if(j=Qa.currentCall,null!==j){if(d.logTrace(j.peer(),j),d.logInfo("There is an existing conference"),"hold"!==a.action&&"end"!==a.action)return void g("3241");if("hold"===a.action)return"held"===j.state()||"hold"===j.state()?void b():(d.logInfo("Putting the current conference on hold"),j.on("held",b),j.hold(),void(j.autoresume=!0));if("end"===a.action){if(d.logInfo("Ending the current conference"),e=j.breed(),j.on("disconnected",b),"conference"===e)return void j.disconnectConference();j.disconnect()}return}void 0!==a.action&&d.logWarning("There is no current call. Action `"+a.action+"` will be ignored"),ja(f,a),d.logTrace(f.peer(),f)}catch(k){d.logError("Error during joinConference"),d.logTrace(k),g("3200",k)}}function ma(a){d.logDebug("ATT.rtc.Phone: addParticipant"),d.logTrace("participant",a);var b,c,f;if(!Va)return void g("0002");if("string"!=typeof a||0===a.length)return void g("3611");if(d.logInfo("Validating participant to add"),K(a))return void g("3612");if(a.split("@").length>2)return void g("3613");if(null===Qa.getId())return void g("3621");if(b=Qa.currentCall,d.logTrace(b.peer(),b),null===b||"conference"!==b.breed())return d.logError("Conference not initiated "),void g("3631");d.logTrace("participant",a);try{if(d.logInfo("Adding Participant..."),d.logInfo("Getting list of current participants"),f=b.participants(),d.logTrace("currentParticipants",f),0<Object.keys(f).length)for(c in f)if(f.hasOwnProperty(c)&&c===a)return void g("3641",new Error(c+" is already a party to this conference"));e("conference:invitation-sending",{invitee:a,timestamp:new Date}),b.addParticipant(a)}catch(h){d.logInfo("Error during addParticipant"),d.logTrace(h),g("3600",h)}}function na(){d.logDebug("ATT.rtc.Phone: getParticipants");var a,b;if(null===Qa.getId())return void g("3401");if(a=Qa.currentCall,null===a||"conference"!==a.breed())return void g("3402");try{return d.logTrace(a.peer(),a),d.logInfo("Getting participants..."),b=a.participants(),d.logTrace("participants",b),b}catch(c){d.logError("Error during getParticipants"),d.logTrace(c),g("3400",c)}}function oa(a){d.logDebug("ATT.rtc.Phone: removeParticipant");var b;if(!Va)return void g("0002");if(void 0===a)return void g("3711");if(null===Qa.getId())return void g("3721");if(b=Qa.currentCall,null===b||"conference"!==b.breed())return void g("3731");try{d.logTrace(b.peer(),b),d.logInfo("Removing participant"),b.removeParticipant(a)}catch(c){d.logError("Error during removeParticipant"),d.logTrace(c),g("3700",c)}}function pa(){d.logDebug("ATT.rtc.Phone: endConference");var a;if(!Va)return void g("0002");if(null===Qa.getId())return void g("3501");if(a=Qa.currentCall,null===a||"conference"!==a.breed())return void g("3502");try{d.logTrace(a.peer(),a),a.on("disconnecting",function(a){d.logDebug("conference.on: disconnecting"),d.logInfo("conference:disconnecting event by ATT.rtc.Phone"),d.logTrace("data",a),e("conference:disconnecting",a)}),d.logInfo("Disconnecting conference"),a.disconnectConference()}catch(b){d.logError("Error during endConference"),d.logTrace(b),g("3500",b)}}function qa(){d.logDebug("ATT.rtc.Phone: mute");var a;if(null===Qa.getId())return void g("2701");if(a=Qa.currentCall,null===a||null===a.id)return void g("2702");d.logTrace(a.peer(),a);try{if(a.off("muted",u),a.on("muted",u),a.muted())return d.logWarning("warning event by ATT.rtc.Phone"),void e("warning",{message:"Cannot mute call that is already muted"});d.logInfo("Muting..."),a.mute()}catch(b){d.logError("Error during mute"),d.logTrace(b),g("2700",b)}}function ra(){d.logDebug("ATT.rtc.Phone: unmute");var a;if(null===Qa.getId())return void g("2801");if(a=Qa.currentCall,null===a||null===a.id)return void g("2802");try{if(d.logTrace(a.peer(),a),a.off("unmuted",v),a.on("unmuted",v),!a.muted())return d.logWarning("warning event by ATT.rtc.Phone"),void e("warning",{message:"Cannot umute call that is not muted"});d.logInfo("Unmuting..."),a.unmute()}catch(b){d.logError("Error during unmute"),d.logTrace(b),g("2800",b)}}function sa(){d.logDebug("ATT.rtc.Phone: hold");var a;if(null===Qa.getId())return void g("2501");if(a=Qa.currentCall,null===a||null===a.id())return void g("2502");try{d.logTrace(a.peer(),a),a.validateOperation("hold"),d.logInfo("Holding..."),a.hold()}catch(b){if(d.logError("Error during hold"),d.logTrace(b),"Error"===b.name)return void g("2503",b);g("2500",b)}}function ta(){d.logDebug("ATT.rtc.Phone: resume");var a;if(null===Qa.getId())return void g("2601");if(a=Qa.currentCall,null===a||null===a.id())return void g("2602");try{d.logTrace(a.peer(),a),a.validateOperation("resume"),d.logInfo("Resuming..."),a.resume()}catch(b){if(d.logError("Error during resume"),d.logTrace(b),"Error"===b.name)return void g("2603",b);g("2600",b)}}function ua(){d.logDebug("ATT.rtc.Phone: move");var a;if(null===Qa.getId())return void g("4001");if(a=Qa.currentCall,null===a||null===a.id())return void g("4002");if("conference"===a.breed())return void g("4004");try{d.logTrace(a.peer(),a),a.validateOperation("move"),d.logInfo("Moving..."),a.move()}catch(b){if(d.logError("Error during move"),d.logTrace(b),"Error"===b.name)return void g("4003",b);g("4000",b)}}function va(){function a(){d.logDebug("ATT.rtc.Phone: switchToCall");var c,e,f;b.off("held",a),e=Qa.getCalls();for(c in e)if(e.hasOwnProperty(c)&&c!==b.id()){f=c;break}d.logInfo("Switching calls..."),d.logTrace("Switch to call id",f),Qa.switchTo(f)}d.logDebug("ATT.rtc.Phone: switchCall");var b=Qa.currentCall;if(null===Qa.getId())return void g("4201");if(null===Qa.currentCall||null===Qa.currentCall.id())return void g("4202");if(2>Object.keys(Qa.getCalls()).length)return void g("4203");try{if(d.logTrace(b.peer(),b),"held"!==b.state())return d.logInfo("Putting current call on hold"),b.on("held",a),b.hold(),void(b.autoresume=!0);a()}catch(c){d.logError("Error during switch"),d.logTrace(c),g("4200",c)}}function wa(){d.logDebug("ATT.rtc.Phone: transfer");var a,b,c,e;if(!Va)return void g("0002");if(null===Qa.getId())return void g("4101");if(a=Qa.currentCall,null===a||null===a.id())return void g("4102");if("conference"===a.breed())return void g("4104");if(2>Object.keys(Qa.getCalls()).length)return void g("4105");try{d.logTrace("currentCall",a.peer()),d.logTrace("currentCall id",a.id()),d.logInfo("Retrieving background call for transfer"),b=Qa.getCalls();for(c in b)if(b.hasOwnProperty(c)&&c!==Qa.currentCall.id()){e=Qa.getCall(c);break}if(d.logTrace("backgroundCall",e.peer()),d.logTrace("backgroundCall id",e.peer()),"conference"===e.breed())return void g("4104");e.validateOperation("transfer"),e.off("transferring",E),e.on("transferring",E),e.off("transferred",F),e.on("transferred",F),d.logInfo("Transferring call with peer "+e.peer()+" to "+a.peer()),e.transfer({targetCallId:a.id()})}catch(f){if(d.logError("Error during transfer call"),d.logTrace(f),"Error"===f.name)return void g("4103",f);g("4100",f)}}function xa(){d.logInfo("Starting downgrade..."),d.logDebug("Phone: downgrade");var a;if(null===Qa.getId())return void g("4501");if(a=Qa.currentCall,null===a||void 0===a.id())return void g("4502");if("audio"===a.mediaType())return void g("4504");if("conference"===a.breed())return void g("4505");try{a.validateOperation("downgrade"),d.logInfo("Trying to get the audio media stream"),n("audio",function(b){d.logInfo("Successfully got user media."),Oa=b,a.removeStream(a.localStream()),a.addStream(Oa),j("local",Oa),a.connect()},function(a){d.logError("Failed to get user media during downgrade"),d.logTrace("error",a),g("0020",a)})}catch(b){if(d.logError("Error during downgrade"),d.logTrace(b),"Error"===b.name)return void g("4503",b);g("4500",b)}}function ya(){d.logInfo("Starting upgrade..."),d.logDebug("ATT.rtc.Phone: upgrade");var a;if(null===Qa.getId())return void g("4601");if(a=Qa.currentCall,null===a)return void g("4602");if("video"===a.mediaType())return void g("4604");if("conference"===a.breed())return void g("4605");try{a.validateOperation("upgrade"),d.logInfo("Trying to get the video media stream"),n("video",function(b){d.logInfo("Entered onUserMedia"),Oa=b,a.removeStream(a.localStream()),a.addStream(Oa),j("local",Oa),a.connect()},function(a){d.logError("Failed to get user media during upgrade"),d.logTrace(a),g("0020",a)})}catch(b){if(d.logError("Error during upgrade"),d.logTrace(b),"Error"===b.name)return void g("4603",b);g("4600",b)}}function za(){d.logDebug("Phone: acceptModification");var a;if(null===Qa.getId())return void g("4301");if(a=Qa.currentCall,null===a||null===a.id())return void g("4302");if(void 0===a.modifications()||null===a.modifications())return void g("4304");try{a.validateOperation("acceptMod"),d.logInfo("Trying to get the "+a.modifications().mediaType+" media stream"),n(a.modifications().mediaType,function(b){d.logInfo("Successfully got user media."),Oa=b,a.removeStream(a.localStream()),a.addStream(Oa),j("local",Oa),a.connect()},function(a){d.logError("Failed to get user media during acceptModification"),d.logTrace("error",a),g("0020")})}catch(b){if(d.logInfo("Error during acceptModification"),d.logTrace("error",b),"Error"===b.name)return void g("4303",b);g("4300",b)}}function Aa(){d.logDebug("Phone: rejectModification");var a;if(null===Qa.getId())return void g("4401");if(a=Qa.currentCall,null===a||null===a.id())return void g("4402");if(void 0===a.modifications()||null===a.modifications())return void g("4404");try{a.validateOperation("rejectMod"),d.logInfo("Rejecting media modification..."),a.connect()}catch(b){if(d.logInfo("Error during rejectModification"),d.logTrace("error",b),"Error"===b.name)return void g("4403",b);g("4400",b)}}function Ba(){d.logDebug("ATT.rtc.Phone: getMediaType"),d.logInfo("Getting current call media type...");var a=Qa.currentCall;return d.logTrace(a.peer(),a),d.logTrace("MediaType",a.mediaType()),a?a.mediaType():null}function Ca(){d.logDebug("ATT.rtc.Phone: isCallInProgress"),d.logInfo("Checking if current call exists...");var a=Qa.currentCall;return null!==a?(d.logTrace("Call in progress",!0),d.logTrace(a.peer(),a),!0):(d.logTrace("Call in not in progress",!1),!1)}function Da(a){d.logDebug("ATT.rtc.Phone: sendDTMFTone"),d.logInfo("Sending DTMF tone..."),d.logTrace("options",a);var b;if(!Va)return void g("0002");if(void 0===a)return void g("4711");if(void 0===a.input)return void g("4712");if(null===Qa.getId())return void g("4721");if(b=Qa.currentCall,null===b||null===b.id())return void g("4731");try{b.validateOperation("sendDTMFTone"),b.off("tone-sending",I),b.off("tone-sent",J),b.on("tone-sending",I),b.on("tone-sent",J),d.logInfo("sending the dial tone"),b.sendDTMFTone(a)}catch(c){if(d.logInfo("Error during sendDTMDTone"),d.logTrace("error",c),"Error"===c.name)return void g("4741",c);g("4700",c)}}function Ea(){d.logDebug("ATT.rtc.phone: getIceServers"),d.logInfo("getting current iceServer value of peerConnection");var a=Qa.getPCConfiguration().iceServers;return d.logTrace("iceServers",a),a}function Fa(a){d.logDebug("ATT.rtc.phone: setIceServers"),d.logInfo("sets the new iceServers value to peerConnection"),d.logTrace("iceServers",a);try{Qa.setPCConfiguration({iceServers:a})}catch(b){g("4811",b)}}function Ga(){d.logDebug("ATT.rtc.phone: resetIceServers"),d.logInfo("Reset iceServers value of peerConnection to default"),Qa.resetPCConfiguration("iceServers")}function Ha(){d.logDebug("ATT.rtc.phone: getIceTransport"),d.logInfo("getting current iceTransport value of peerConnection");var a=Qa.getPCConfiguration().iceTransports;return d.logTrace("iceTransports",a),a}function Ia(a){d.logDebug("ATT.rtc.phone: setIceTransport"),d.logInfo("sets the new iceTransport value to peerConnection"),d.logTrace("iceTransports",a);try{Qa.setPCConfiguration({iceTransports:a})}catch(b){g("4821",b)}}function Ja(){d.logDebug("ATT.rtc.phone: resetIceTransport"),d.logInfo("Reset iceTransport value of peerConnection to default"),Qa.resetPCConfiguration("iceTransports")}function Ka(){d.logDebug("ATT.rtc.phone: getIpv6"),d.logInfo("getting current ipv6 value of peerConnection");var a=Qa.getPCConfiguration().ipv6;return d.logTrace("ipv6",a),a}function La(a){d.logDebug("ATT.rtc.phone: setIpv6"),d.logInfo("sets the new ipv6 value to peerConnection"),d.logTrace("ipv6",a);try{Qa.setPCConfiguration({ipv6:a})}catch(b){g("4831",b)}}function Ma(){d.logDebug("ATT.rtc.phone: resetIpv6"),d.logInfo("Reset ipv6 value of peerConnection to default"),Qa.resetPCConfiguration("ipv6")}function Na(){return Qa.getVersion()}var Oa,Pa=b.createEventEmitter(),Qa=new ATT.rtc.Session,Ra=ATT.errorDictionary,Sa=null,Ta=null,Ua=[],Va=!1;d.logDebug("ATT.rtc.Phone: Constructor"),d.logInfo("Creating a new instance of Phone"),Qa.on("call:incoming",function(a){d.logDebug("session.on: call:incoming"),d.logInfo("call:incoming event  by ATT.rtc.Phone"),d.logTrace("data",a),e("call:incoming",a),Qa.pendingCall&&(Qa.pendingCall.on("canceled",s.bind(null,Qa.pendingCall)),Qa.pendingCall.on("disconnected",r.bind(null,Qa.pendingCall)))}),Qa.on("conference-invite",function(a){d.logDebug("session.on: conference-invite"),d.logInfo("conference:invitation-received event by ATT.rtc.Phone"),d.logTrace("data",a),e("conference:invitation-received",a),Qa.pendingCall&&(Qa.pendingCall.on("canceled",s.bind(null,Qa.pendingCall)),Qa.pendingCall.on("disconnected",r.bind(null,Qa.pendingCall)))}),Qa.on("call:switched",function(a){d.logDebug("session.on: call:switched"),d.logInfo("session:call-switched event by ATT.rtc.Phone"),d.logTrace("data",a),e("session:call-switched",a)}),Qa.on("notification",function(a){d.logDebug("session.on: notification"),d.logInfo("notification event by ATT.rtc.Phone"),d.logTrace("data",a),e("notification",a)}),Qa.on("error",p),this.isOnline=function(){return Va},this.on=R,this.setup=S,this.getSession=L,this.associateAccessToken=W,this.associateE911Id=X,this.login=V,this.logout=Y,this.dial=aa,this.addCall=ba,this.answer=da,this.hangup=ea,this.cancel=fa,this.reject=ha,this.move=ua,this.transfer=wa,this.downgrade=xa,this.upgrade=ya,this.acceptModification=za,this.rejectModification=Aa,this.startConference=ia,this.joinConference=la,this.endConference=pa,this.rejectConference=ka,this.addParticipant=ma,this.getParticipants=na,this.removeParticipant=oa,this.mute=qa,this.unmute=ra,this.hold=sa,this.resume=ta,this.switchCall=va,this.eventsPublished=M,this.lastEventPublished=N,this.getUserMedia=T,this.releaseLocalUserMedia=o,this.getCalls=U,this.getMediaType=Ba,this.isCallInProgress=Ca,this.cleanPhoneNumber=O,this.formatNumber=P,this.getCallerInfo=Q,this.sendDTMFTone=Da,this.getIceServers=Ea,this.setIceServers=Fa,this.resetIceServers=Ga,this.getIceTransport=Ha,this.setIceTransport=Ia,this.resetIceTransport=Ja,this.getIpv6=Ka,this.setIpv6=La,this.resetIpv6=Ma,this.getVersion=Na;try{ATT["private"].factories.createNetworkListener({online:function(){Va=!0,e("connectivity:on")},offline:function(){Va=!1,e("connectivity:off")}})}catch(Wa){g("1004")}void 0!==a&&a.test&&(this.localMedia=function(){return Sa},this.remoteMedia=function(){return Ta},this.localStream=function(){return Oa},this.setLocalStream=function(a){Oa=a})}var b=ATT["private"].factories,c=ATT["private"]["enum"],d=ATT.logManager.createLogger("phone");if(d.logDebug("Loading att.rtc.phone..."),void 0===ATT["private"])throw new Error("Error exporting ATT.private.Phone.");if(ATT["private"].Phone=a,void 0===ATT.rtc)throw new Error("Error exporting ATT.rtc.Phone.");ATT.rtc.Phone=function(){var b;return{getPhone:function(){return d.logDebug("ATT.rtc.Phone: getPhone"),void 0===b&&(b=new a),b}}}()}(),function(){"use strict";function a(a){if(i.logDebug("ATT.rtc: configure"),i.logTrace("options",a),i.logDebug("Configuring the SDK"),void 0===a||0===Object.keys(a).length)throw new Error("No options provided");h.app.setAppConfiguration(a)}function b(){return ATT.rtc.Phone.getPhone().getSession()}function c(){return b().getSupportedAudioCodecs()}function d(){return b().getPCConfiguration().audioCodec}function e(a){b().setPCConfiguration({audioCodec:a})}function f(){b().resetPCConfiguration("audioCodec")}function g(){return b().getVersion()}var h=ATT["private"].config,i=ATT.logManager.createLogger("rtc");i.logDebug("Loading att.rtc..."),ATT.rtc.getSupportedAudioCodecs=c,ATT.rtc.getAudioCodec=d,ATT.rtc.setAudioCodec=e,ATT.rtc.resetAudioCodec=f,ATT.rtc.configure=a,ATT.rtc.getVersion=g}(),function(){"use strict";var a,b=ATT.logManager.createLogger("main");return b.logDebug("Loading att.main..."),b.logInfo("Attempting to load Enhanced WebRC SDK..."),void 0===window.ATT?void b.logError("Cannot load ATT's Enhanced WebRTC SDK. ATT is not defined."):(a=window.ATT,window.ATT=void 0,"Not Supported"===a.browser.hasWebRTC()?(window.ATT={browser:a.browser},void b.logError("Failed to load ATT's Enhanced WebRTC SDK. The browser doesn't support Enhanced WebRTC")):(window.ATT=a,b.logInfo("Loading error dictionary..."),void 0===ATT["private"].createErrorDictionary?void b.logError("Failed to load error dictionary. Missing ATT.private.createErrorDictionary."):(ATT.errorDictionary=ATT["private"].createErrorDictionary(ATT["private"].errorStore.SDKErrors,ATT["private"].errorStore.APIErrors),(void 0===ATT.errorDictionary||null===ATT.errorDictionary)&&b.logError("Failed to create error dictionary"),b.logInfo("Loading error dictionary complete"),void b.logInfo("Loading Enhanced WebRC SDK complete"))))}();